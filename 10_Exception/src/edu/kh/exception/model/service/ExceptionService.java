...
// java.lang - 기본적으로 모든 java 프로그램에 자동 포함.
...
public class ExceptionService {
    ...
    public void ex1() {
        ...
        try {
            ...
            // try 에서 던저진 예외를 catch 문의 매개변수 e 로 잡음
            // e 를 사용하여 예외추적 코드 작성할 수도 있음
            System.out.println("infinity");
            e.printStackTrace();
    ...
    public void ex2() {
        ...
        try {
            ...
            System.out.println("타입에 맞는 값 만 입력하세요.");
            ...
            e.printStackTrace();
            // 발생한 예외에 대한 메서드와 위치에 대한 모든 내용 처리
        }
    }
    
    public void ex3() {
    	// try catch - finally
    	// finally : trt 구문에서 예외가 발생 하든말든 무조건 마지막에 수행
    	try {
            System.out.print("정수 1 입력 : ");
            int input1 = sc.nextInt(); // InputMismatchException
            // int 형이 아닌 다른 자료형을 대입했을때
    ...
    public void ex4() {
    	...
    	try {
    		...
    		System.out.println("method 에서부터 발생한 예외를 ex4 에서 받아 처리함.");
    	}
