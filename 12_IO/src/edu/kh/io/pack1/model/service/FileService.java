...
public class FileService {
    ...
    public void method1() {
        ...
        // 리눅스, mac 에서는 Users/ , 윈도우 에서는 C:/ , D:/ 등
    ...
    public void method2() {
    	...
    	if(!file.exists()) { // 존재하지 않으면
    		...
    		try {
				...
				e.printStackTrace(); // 예외 정보 + 예외가 발생한 위치 까지의 메서드 추적
			}
    	}
    }
    ...
    public void method3() {
    	...
    	for(File f : files) {
    		...
    		if(f.isDirectory()) size = ""; // 폴더라면 사이즈 빈 문자열로 변경
