package edu.kh.network.server.model.sevice;
...
public class ServerService {
	...
	public void serverStart() {
		...
		try {
			...
			// 바이트 기반 InputStream 를 연결할 수 있도록
			...
			// SimpleDateFormat : 날따 형식을 간단히 지정하는 객체
