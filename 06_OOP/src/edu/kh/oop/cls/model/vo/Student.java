...
// [접근제한자] [예약어(생략가능)] class 클래스명
	...
	// 클래스 변수(== static 변수) : 빌드에 static 예약어가 작성된 변수
	...
	int v3 = 30; // (default) 같은 패키지 내 까지 가능
	...
	// final 예약어
	private final int TEMP1 = 100;//상수는 대문자로만 표기
	// getter 만 만들어진 이유 : final 예약어가 붙은 TEMP1 은 상수
	// 재대입 불가함 == setter 만들어지지 않음
	public int getTEMP1() {
		return TEMP1;
	}
