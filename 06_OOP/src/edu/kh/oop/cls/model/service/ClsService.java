...
public class ClsService /*extends Student*/{
	...
	public void ex1() {
		...
		// ((default) 클래스인 TestVo 는 import 불가능(다른 패키지라 불가능)
		
		// 필드 접근 제한자 확인하기
		System.out.println(std.v1);
		// -> 전체에서 직접 접근 가능한 public 인 v1 만 에러발생 x
		...
		// Student의 protected 변수인 v2 는 직접접근 가능!
	...
	public void ex3() {
		...
		// u2 가 참조하고 있는 User 객체의 필드값이 모두 동일함
		// 왜? 같은 기본 생성자롤 user 객체를 생성했기 때문에
...
System.out.printf("u2 : %s / %s / %s / %d / %c\n"
		, u1.getUserId(),u2.getUserPw(),u2.getUserName(),u2.getUserAge(),u2.getUserGender());
